...
export const UserSignInView: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white px-4 sm:px-12 py-6 sm:py-8 flex flex-col justify-between overflow-y-auto">
      {/* Responsive Web & Mobile Layout Container */}
      <div className="max-w-4xl mx-auto w-full my-auto py-2 sm:py-6 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">

        {/* Bullet Points Container (Left Column on Desktop, Top on Mobile) */}
        <div className="bg-neutral-950 p-4 sm:p-7 rounded-2xl border border-neutral-800 shadow-xl space-y-3.5 sm:space-y-4">
          <h3 className="text-gold font-extrabold text-base sm:text-lg border-b border-neutral-800 pb-2 flex items-center gap-2">
          ...
          <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm leading-snug">
            ...
            <div className="flex items-start gap-3 sm:gap-3.5 pb-2.5 sm:pb-3 border-b border-neutral-800">
              ...
              <p className="text-white">
                ...
                <strong className="font-extrabold text-white">online number game</strong> with 3 different modes.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 sm:gap-3.5 pb-2.5 sm:pb-3 border-b border-neutral-800">
              ...
              <p className="text-white">
                ...
                <strong className="font-extrabold text-white">win cash prizes from ₹5,000 to ₹1,00,000</strong>.
              </p>
            </div>
        ...
        <div className="bg-neutral-950 p-5 sm:p-8 rounded-2xl border border-neutral-800 shadow-xl flex flex-col items-center max-w-sm mx-auto w-full">
          <Lucky10Logo size="lg" showSubtitle={true} />

          <form onSubmit={handleSubmit} className="w-full space-y-3.5 sm:space-y-4 mt-3 sm:mt-4">
            <div>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 sm:py-3.5 bg-white text-black placeholder-gray-500 font-medium rounded-lg focus:outline-none text-sm sm:text-base shadow border-0"
                required
              />
            </div>
            ...
            <div className="flex items-center justify-between text-xs sm:text-sm text-white px-1 pt-1 font-normal">
              <button
                type="button"
              ...
              <button
                ...
                className="hover:text-gold transition-colors text-white font-normal"
              >
                Sign Up
              </button>
            </div>
            ...
            <div className="pt-3 sm:pt-4 flex justify-center">
              <button
                type="submit"
                className="w-36 sm:w-44 py-3 sm:py-3.5 bg-gold-metallic text-black font-black text-sm sm:text-base tracking-wider rounded-lg shadow-lg uppercase hover:opacity-95 transition-transform active:scale-98"
              >
                SIGN IN
              </button>
            </div>
      ...
      {/* Footer Info */}
      <div className="text-center pt-3 pb-2 border-t border-neutral-900 flex justify-center items-center text-xs text-neutral-500 max-w-4xl mx-auto w-full">
