    ...
    <div className="w-full min-h-screen min-h-[100dvh] bg-black text-white flex flex-col justify-start overflow-y-auto pb-16 antialiased select-none font-sans">
      ...
      <div className="w-full px-3 sm:px-8 py-3 max-w-4xl mx-auto flex-1 flex flex-col space-y-3 sm:space-y-4">
        ...
        <div className="w-full flex-1 min-h-[280px] sm:min-h-[340px] max-h-[480px] sm:max-h-[540px] border border-neutral-700 rounded-xl overflow-hidden bg-white text-black shadow-lg flex flex-col">
          <div className="grid grid-cols-5 bg-gray-100 border-b border-gray-300 font-black text-[11px] sm:text-xs py-1 px-1 text-center shrink-0">
          ...
          <div className="divide-y divide-gray-200 flex-1 min-h-0 overflow-y-auto text-[11px] sm:text-xs font-bold">
                ...
                betSlip.map((item) => {
                  ...
                  return (
                    <div key={item.id} className="grid grid-cols-5 py-0.5 px-1 items-center text-center bg-white hover:bg-neutral-50 transition-colors">
                      <span className={`font-black text-[11px] sm:text-xs uppercase border-r border-gray-200 truncate px-0.5 ${typeTextColor}`}>
                        {displayType}
                      </span>
                      <span className={`font-mono font-bold text-[11px] sm:text-xs border-r border-gray-200 truncate px-0.5 ${textColor}`}>
                        {displayNumber}
                      </span>
                      <span className={`font-mono font-bold text-[11px] sm:text-xs border-r border-gray-200 truncate px-0.5 ${textColor}`}>
                        {item.count}
