    ...
    <div className="fixed inset-0 w-full h-[100dvh] max-h-[100dvh] bg-black text-white px-3 sm:px-6 py-2 sm:py-6 flex flex-col justify-center items-center overflow-hidden overscroll-none touch-none select-none z-50">
      ...
      <div className="relative max-w-md mx-auto w-full my-auto bg-neutral-950/95 p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-gold/40 shadow-[0_0_50px_rgba(212,175,55,0.22)] flex flex-col items-center">
        ...
        <div className="mt-2 sm:mt-4">
          <h2 className="text-base sm:text-lg font-black text-gold tracking-wider uppercase text-center">
            ADMIN PORTAL
          </h2>
        </div>

        <form onSubmit={handleSubmit} className="w-full space-y-2.5 sm:space-y-4 mt-5 sm:mt-6">
          <div>
            <input
              type="text"
          ...
          <div className="relative w-full">
            <input
              ...
              className="w-full px-3.5 py-2.5 sm:py-3.5 pr-10 bg-white text-black placeholder-neutral-500 font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-gold text-xs sm:text-base shadow border-0"
              required
            />
            <button
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-black focus:outline-none p-1 cursor-pointer"
          ...
          <div className="pt-2 sm:pt-4 flex justify-center">
            <button
              type="submit"
              className="w-36 sm:w-44 py-2.5 sm:py-3.5 bg-gold-metallic text-black font-black text-xs sm:text-base tracking-wider rounded-lg shadow-[0_4px_25px_rgba(212,175,55,0.35)] uppercase hover:opacity-95 transition-all active:scale-95 cursor-pointer"
            >
              SIGN IN
            </button>
          </div>
        ...
        <div className="mt-4 pt-2 text-center">
          <button
            ...
            className="text-xs sm:text-sm text-neutral-400 hover:text-gold transition-colors cursor-pointer font-medium"
          >
